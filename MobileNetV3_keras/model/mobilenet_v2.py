...
def MobileNetv2(input_shape, k):
    ...
    x = _inverted_residual_block(x, 64, (3, 3), t=2, strides=2, n=3)
    x = _inverted_residual_block(x, 96, (3, 3), t=2, strides=1, n=2)
    x = _inverted_residual_block(x, 160, (3, 3), t=2, strides=2, n=2) 
